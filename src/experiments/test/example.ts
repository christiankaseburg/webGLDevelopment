...
import { PingPongTexture } from '../../helpers/PingPongTexture';
import { Godrays } from '../../helpers/postprocessing/godrays';
...
class GodraysExperiment {
    ...
    private materialVertexShader = require('../../helpers/shaders/godraysExperimentShaders/mesh.vert');
    private materialFragmentShader = require('../../helpers/shaders/godraysExperimentShaders/mesh.frag');
    private occlusionFragmentShader = require('../../helpers/shaders/godraysExperimentShaders/occlusion.frag');
    private occlusionVertexShader = require('../../helpers/shaders/godraysExperimentShaders/occlusion.vert');
    private simVertexShader = require('../../helpers/shaders/godraysExperimentShaders/simulation.vert');
    private simFragmentShader = require('../../helpers/shaders/godraysExperimentShaders/simulation.frag');
...
if(window.location.pathname == '/src/experiments/godrays/index.html') {
    let experiment = new GodraysExperiment();
    experiment.load();
}
